...
import { Package, Search, Plus, Edit3, Trash2, ExternalLink, Euro, RefreshCw, TrendingUp, TrendingDown, AlertCircle, BarChart3 } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold">Produits Scellés</h2>
              ...
              {filteredProducts.map((product) => (
                <Card key={product.id} className="overflow-hidden">
                  <CardContent className="p-4">
                    ...
                    {product.cardmarket_id_product && (
                      <a
                        href={CardMarketSupabaseService.buildSealedProductUrl(product.cardmarket_id_product, product.name)}
                        target="_blank"
